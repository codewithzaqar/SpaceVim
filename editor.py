...
class Editor:
    def __init__(self, root, status_update_callback):
        self.text = tk.Text(root, wrap="none", undo=True, font=("Courier", 12))
        self.text.insert("1.0", "Welcome to SpaceVim-Tk v0.1.1\n")
        ...
        self.text.bind("<KeyRelease>", status_update_callback)
        self.text.bind("<ButtonRelease>", status_update_callback)